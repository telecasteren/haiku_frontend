...
export const aboutSection: AboutSection[] = [
  {
    ...
    content:
      "We started out as a small coffee shop in the heart of the city. Basically a 'hole-in-the-wall' kind of situation.",
  ...
  },
  {
    ...
    title: "Work with us",
    content:
      "Either you're a farmer or a coffee enthusiast, we're always on the lookout for the right colabs and people to join our team.",
